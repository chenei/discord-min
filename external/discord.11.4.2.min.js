!(function (e) {
    ...
    (function (e) {
      (t.Package = s(37)),
        (t.DefaultOptions = {
          ...
          ws: {
            large_threshold: 250,
            compress: "browser" !== s(69).platform(),
            properties: {
              $os: e ? e.platform : "discord.js",
              $browser: "discord.js",
              $device: "discord.js",
              $referrer: "",
              $referring_domain: "",
      ...
      const i = (t.Endpoints = {
        User: (e) => {
          ...
          return {
            ...
            settings: `${t}/settings`,
            Relationship: (e) => `${t}/relationships/${e}`,
            Guild: (e) => ({
              toString: () => `${t}/guilds/${e}`,
              settings: `${t}/guilds/${e}/settings`,
            }),
            Note: (e) => `${t}/notes/${e}`,
            Mentions: (e, s, i, n) =>
              `${t}/mentions?limit=${e}&roles=${s}&everyone=${i}${
                n ? `&guild_id=${n}` : ""
              }`,
            Avatar: (t, s) => ("1" === e ? s : i.CDN(t).Avatar(e, s)),
          };
        },
        guilds: "/guilds",
        Guild: (e) => {
          ...
          return {
            ...
            roles: `${t}/roles`,
            emojis: `${t}/emojis`,
            search: `${t}/messages/search`,
            voiceRegions: `${t}/regions`,
            webhooks: `${t}/webhooks`,
            ack: `${t}/ack`,
            settings: `${t}/settings`,
            auditLogs: `${t}/audit-logs`,
            Emoji: (e) => `${t}/emojis/${e}`,
            Icon: (t, s) => i.CDN(t).Icon(e, s),
            Splash: (t, s) => i.CDN(t).Splash(e, s),
            Role: (e) => `${t}/roles/${e}`,
            Member: (e) => {
              e.id && (e = e.id);
              const s = `${t}/members/${e}`;
        ...
        Channel: (e) => {
          ...
          return {
            ...
            messages: {
              toString: () => `${t}/messages`,
              bulkDelete: `${t}/messages/bulk-delete`,
            },
            invites: `${t}/invites`,
            typing: `${t}/typing`,
            ...
            search: `${t}/messages/search`,
            pins: `${t}/pins`,
            Icon: (t, s) => i.CDN(t).GDMIcon(e, s),
            Pin: (e) => `${t}/pins/${e}`,
            Recipient: (e) => `${t}/recipients/${e}`,
            Message: (e) => {
              e.id && (e = e.id);
  ...
  function (e, t, s) {
    ...
    e.exports = class GuildRoleDeleteHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.GuildRoleDelete.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class GuildRoleUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.GuildRoleUpdate.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class GuildEmojisUpdate extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.GuildEmojisUpdate.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0);
    e.exports = class GuildMembersChunkHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d,
          i = t.guilds.get(s.guild_id);
        if (!i) return;
        const r = s.members.map((e) => i._addMember(e, !1));
        t.emit(n.Events.GUILD_MEMBERS_CHUNK, r, i),
          (t.ws.lastHeartbeatAck = !0);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class ChannelCreateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.ChannelCreate.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0);
    e.exports = class ChannelDeleteHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d,
          i = t.actions.ChannelDelete.handle(s);
        i.channel && t.emit(n.Events.CHANNEL_DELETE, i.channel);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class ChannelUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.ChannelUpdate.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0);
    e.exports = class ChannelPinsUpdate extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d,
          i = t.channels.get(s.channel_id),
          r = new Date(s.last_pin_timestamp);
        i && r && t.emit(n.Events.CHANNEL_PINS_UPDATE, i, r);
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0),
      r = s(4);
    e.exports = class PresenceUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        let i = t.users.get(s.user.id);
        const o = t.guilds.get(s.guild_id);
        if (!i) {
          if (!s.user.username) return;
          i = t.dataManager.newUser(s.user);
        }
        const a = r.cloneObject(i);
        if (
          (i.patch(s.user),
          i.equals(a) || t.emit(n.Events.USER_UPDATE, a, i),
          o)
        ) {
          let e = o.members.get(i.id);
          if (
            (e ||
              "offline" === s.status ||
              ((e = o._addMember(
                { user: i, roles: s.roles, deaf: !1, mute: !1 },
                !1
              )),
              t.emit(n.Events.GUILD_MEMBER_AVAILABLE, e)),
            e)
          ) {
            if (0 === t.listenerCount(n.Events.PRESENCE_UPDATE))
              return void o._setPresence(i.id, s);
            const a = r.cloneObject(e);
            e.presence && (a.frozenPresence = r.cloneObject(e.presence)),
              o._setPresence(i.id, s),
              t.emit(n.Events.PRESENCE_UPDATE, a, e);
          } else o._setPresence(i.id, s);
        }
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class UserUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.UserUpdate.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class UserNoteUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.UserNoteUpdate.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0);
    e.exports = class UserSettingsUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client;
        t.user.settings.patch(e.d),
          t.emit(n.Events.USER_SETTINGS_UPDATE, t.user.settings);
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0),
      r = s(57);
    e.exports = class UserGuildSettingsUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = t.user.guildSettings.get(e.d.guild_id);
        s
          ? s.patch(e.d)
          : t.user.guildSettings.set(e.d.guild_id, new r(e.d, t)),
          t.emit(
            n.Events.USER_GUILD_SETTINGS_UPDATE,
            t.user.guildSettings.get(e.d.guild_id)
          );
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0),
      r = s(4);
    e.exports = class VoiceStateUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d,
          i = t.guilds.get(s.guild_id);
        if (i) {
          const e = i.members.get(s.user_id);
          if (e) {
            const i = r.cloneObject(e);
            e.voiceChannel &&
              e.voiceChannel.id !== s.channel_id &&
              e.voiceChannel.members.delete(i.id),
              s.channel_id || (e.speaking = null),
              e.user.id === t.user.id &&
                s.channel_id &&
                t.emit("self.voiceStateUpdate", s);
            const o = t.channels.get(s.channel_id);
            o &&
              (o.members.set(e.id, e), e.guild.channels.set(s.channel_id, o)),
              (e.serverMute = s.mute),
              (e.serverDeaf = s.deaf),
              (e.selfMute = s.self_mute),
              (e.selfDeaf = s.self_deaf),
              (e.voiceSessionID = s.session_id),
              (e.voiceChannelID = s.channel_id),
              t.emit(n.Events.VOICE_STATE_UPDATE, i, e);
          }
        }
      }
    };
  ...
  function (e, t, s) {
    ...
    class TypingData {
      constructor(e, t, s, i) {
        (this.client = e),
          (this.since = t),
          (this.lastTimestamp = s),
          (this._timeout = i);
      }
      resetTimeout(e) {
        this.client.clearTimeout(this._timeout), (this._timeout = e);
      }
      get elapsedTime() {
    ...
    function r(e, t) {
      return e.client.setTimeout(() => {
        e.client.emit(n.Events.TYPING_STOP, e, t, e._typing.get(t.id)),
          e._typing.delete(t.id);
      }, 6e3);
    }
    e.exports = class TypingStartHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d,
          i = t.channels.get(s.channel_id),
          o = t.users.get(s.user_id),
          a = new Date(1e3 * s.timestamp);
        if (i && o) {
          if ("voice" === i.type)
            return void t.emit(
              n.Events.WARN,
              `Discord sent a typing packet to voice channel ${i.id}`
            );
          if (i._typing.has(o.id)) {
            const e = i._typing.get(o.id);
            (e.lastTimestamp = a), e.resetTimeout(r(i, o));
          } else
            i._typing.set(o.id, new TypingData(t, a, a, r(i, o))),
              t.emit(n.Events.TYPING_START, i, o);
        }
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0);
    e.exports = class MessageCreateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d,
          i = t.actions.MessageCreate.handle(s);
        i.message && t.emit(n.Events.MESSAGE_CREATE, i.message);
      }
    };
  },
  function (e, t, s) {
    const i = s(1),
      n = s(0);
    e.exports = class MessageDeleteHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d,
          i = t.actions.MessageDelete.handle(s);
        i.message && t.emit(n.Events.MESSAGE_DELETE, i.message);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class MessageUpdateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.MessageUpdate.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class MessageDeleteBulkHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.MessageDeleteBulk.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class VoiceServerUpdate extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.emit("self.voiceServer", s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class GuildSyncHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.GuildSync.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class RelationshipAddHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        1 === s.type
          ? t.fetchUser(s.id).then((e) => {
              t.user.friends.set(e.id, e);
            })
          : 2 === s.type &&
            t.fetchUser(s.id).then((e) => {
              t.user.blocked.set(e.id, e);
            });
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class RelationshipRemoveHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        2 === s.type
          ? t.user.blocked.has(s.id) && t.user.blocked.delete(s.id)
          : 1 === s.type &&
            t.user.friends.has(s.id) &&
            t.user.friends.delete(s.id);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class MessageReactionAddHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.MessageReactionAdd.handle(s);
      }
    };
  },
  function (e, t, s) {
    ...
    e.exports = class MessageReactionRemove extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.MessageReactionRemove.handle(s);
      }
    };
  },
  function (e, t, s) {
    ...
    e.exports = class MessageReactionRemoveAll extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.MessageReactionRemoveAll.handle(s);
      }
    };
  },
  function (e, t) {},
  ...
  function (e, t) {},
  function (e, t, s) {
    const i = s(20).EventEmitter,
      n = s(0),
      r = s(54);
    e.exports = class WebSocketManager extends i {
      constructor(e) {
        super(), (this.client = e), (this.connection = null);
      }
      heartbeat() {
        return this.connection
          ? this.connection.heartbeat()
          : this.debug("No connection to heartbeat");
      }
      debug(e) {
        return this.client.emit("debug", `[ws] ${e}`);
      }
      destroy() {
        return this.connection
      ...
      connect(e) {
        if (!this.connection) return (this.connection = new r(this, e)), !0;
        switch (this.connection.status) {
          case n.Status.IDLE:
          case n.Status.DISCONNECTED:
            return this.connection.connect(e, 5500), !0;
          default:
            return (
              this.debug(
                `Couldn't connect to ${e} as the websocket is at state ${this.connection.status}`
              ),
              !1
            );
        }
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageCreateAction extends i {
      handle(e) {
        const t = this.client,
          s = t.channels.get((e instanceof Array ? e[0] : e).channel_id),
          i = t.users.get((e instanceof Array ? e[0] : e).author.id);
        if (s) {
          const r = s.guild ? s.guild.member(i) : null;
          if (e instanceof Array) {
            const o = new Array(e.length);
            for (let i = 0; i < e.length; i++)
              o[i] = s._cacheMessage(new n(s, e[i], t));
            const a = o[o.length - 1];
            return (
              (s.lastMessageID = a.id),
              (s.lastMessage = a),
              i && ((i.lastMessageID = a.id), (i.lastMessage = a)),
              r && ((r.lastMessageID = a.id), (r.lastMessage = a)),
              { messages: o }
            );
          }
          {
            const o = s._cacheMessage(new n(s, e, t));
            return (
              (s.lastMessageID = e.id),
              (s.lastMessage = o),
              i && ((i.lastMessageID = e.id), (i.lastMessage = o)),
              r && ((r.lastMessageID = e.id), (r.lastMessage = o)),
              { message: o }
            );
          }
        }
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageDeleteAction extends i {
      ...
      handle(e) {
        const t = this.client.channels.get(e.channel_id);
        let s;
        return (
          t &&
            ((s = t.messages.get(e.id))
              ? (t.messages.delete(s.id),
                this.deleted.set(t.id + s.id, s),
                this.scheduleForDeletion(t.id, s.id))
              : (s = this.deleted.get(t.id + e.id) || null),
            s && (s.deleted = !0)),
          { message: s }
        );
      }
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageDeleteBulkAction extends i {
      handle(e) {
        const t = new n(),
          s = this.client.channels.get(e.channel_id);
        if (s)
          for (const i of e.ids) {
            const e = s.messages.get(i);
            e && ((e.deleted = !0), t.set(e.id, e), s.messages.delete(i));
          }
        return (
          t.size > 0 && this.client.emit(r.Events.MESSAGE_BULK_DELETE, t),
          { messages: t }
        );
      }
    };
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageUpdateAction extends i {
      handle(e) {
        const t = this.client,
          s = t.channels.get(e.channel_id);
        if (s) {
          const i = s.messages.get(e.id);
          return i
            ? (i.patch(e),
              t.emit(n.Events.MESSAGE_UPDATE, i._edits[0], i),
              { old: i._edits[0], updated: i })
            : { old: i, updated: i };
        }
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageReactionAdd extends i {
      handle(e) {
        const t = this.client.users.get(e.user_id);
        if (!t) return !1;
        const s = this.client.channels.get(e.channel_id);
        if (!s || "voice" === s.type) return !1;
        const i = s.messages.get(e.message_id);
        if (!i) return !1;
        if (!e.emoji) return !1;
        const r = i._addReaction(e.emoji, t);
        return (
          r && this.client.emit(n.Events.MESSAGE_REACTION_ADD, r, t),
          { message: i, reaction: r, user: t }
        );
      }
    };
  },
  function (e, t, s) {
    ...
    e.exports = class MessageReactionRemove extends i {
      handle(e) {
        ...
        if (!i) return !1;
        if (!e.emoji) return !1;
        const r = i._removeReaction(e.emoji, t);
        return (
          r && this.client.emit(n.Events.MESSAGE_REACTION_REMOVE, r, t),
          { message: i, reaction: r, user: t }
        );
      }
    };
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageReactionRemoveAll extends i {
      handle(e) {
        ...
        const s = t.messages.get(e.message_id);
        return (
          !!s &&
          (s._clearReactions(),
          this.client.emit(n.Events.MESSAGE_REACTION_REMOVE_ALL, s),
          { message: s })
        );
      }
    };
  ...
  function (e, t, s) {
    ...
    e.exports = class ChannelCreateAction extends i {
      handle(e) {
        return { channel: this.client.dataManager.newChannel(e) };
      }
    };
  },
  function (e, t, s) {
    ...
    e.exports = class ChannelDeleteAction extends i {
      ...
      handle(e) {
        const t = this.client;
        let s = t.channels.get(e.id);
        return (
          s
            ? (t.dataManager.killChannel(s),
              this.deleted.set(s.id, s),
              this.scheduleForDeletion(s.id))
            : (s = this.deleted.get(e.id) || null),
          s && (s.deleted = !0),
          { channel: s }
        );
      }
  ...
  function (e, t, s) {
    ...
    e.exports = class ChannelUpdateAction extends i {
      handle(e) {
        const t = this.client,
          s = t.channels.get(e.id);
        if (s) {
          const i = r.cloneObject(s);
          return (
            s.setup(e),
            t.emit(n.Events.CHANNEL_UPDATE, i, s),
            { old: i, updated: s }
          );
        }
        return { old: null, updated: null };
  ...
  function (e, t, s) {
    ...
    e.exports = class GuildDeleteAction extends i {
      ...
      handle(e) {
        const t = this.client;
        let s = t.guilds.get(e.id);
        if (s) {
          for (const e of s.channels.values())
            "text" === e.type && e.stopTyping(!0);
          if (s.available && e.unavailable)
            return (
              (s.available = !1),
              t.emit(n.Events.GUILD_UNAVAILABLE, s),
              { guild: null }
            );
          for (const e of s.channels.values())
            this.client.channels.delete(e.id);
          s.voiceConnection && s.voiceConnection.disconnect(),
            t.guilds.delete(s.id),
            this.deleted.set(s.id, s),
            this.scheduleForDeletion(s.id);
        } else s = this.deleted.get(e.id) || null;
        return s && (s.deleted = !0), { guild: s };
      }
      scheduleForDeletion(e) {
        this.client.setTimeout(
          () => this.deleted.delete(e),
    ...
    e.exports = class GuildUpdateAction extends i {
      handle(e) {
        ...
        if (s) {
          ...
          return (
            s.setup(e),
            t.emit(n.Events.GUILD_UPDATE, i, s),
            { old: i, updated: s }
          );
        }
        return { old: null, updated: null };
  ...
  function (e, t, s) {
    const i = s(2);
    e.exports = class GuildMemberGetAction extends i {
      handle(e, t) {
        return { member: e._addMember(t, !1) };
      }
    };
  },
  function (e, t, s) {
